---
name: model-routing
description: Principles and patterns for model routing
---

# Model Routing

## Purpose
Principles and patterns for model routing
...
## When to Use
- When tasks involve model routing patterns
- When optimizing for quality and consistency in this domain
- When building or improving model routing capabilities
