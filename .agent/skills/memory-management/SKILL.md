...
description: Principles and patterns for memory management
---

# Memory Management

## Purpose
Principles and patterns for memory management
...
## When to Use
- When tasks involve memory management patterns
- When optimizing for quality and consistency in this domain
- When building or improving memory management capabilities
