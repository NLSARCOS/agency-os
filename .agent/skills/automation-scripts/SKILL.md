...
description: Principles and patterns for automation scripts
---

# Automation Scripts

## Purpose
Principles and patterns for automation scripts
...
## When to Use
- When tasks involve automation scripts patterns
- When optimizing for quality and consistency in this domain
- When building or improving automation scripts capabilities
