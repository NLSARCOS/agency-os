...
description: Principles and patterns for prompt engineering
---

# Prompt Engineering

## Purpose
Principles and patterns for prompt engineering
...
## When to Use
- When tasks involve prompt engineering patterns
- When optimizing for quality and consistency in this domain
- When building or improving prompt engineering capabilities
